    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(default=120, help_text='Вверите время на выполнение привычки в секундах', verbose_name='Время')),
                ...
                ('bounded_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='habits.habit', verbose_name='Связанная привычка')),
